      ...
      <div className="container-custom py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center gap-3 text-gray-400">
            ...
            <span className="text-sm">info@hopebridge.org</span>
          </div>
          <div className="flex items-center gap-3 text-gray-400">
          ...
          <div className="flex items-center gap-3 text-gray-400">
            ...
            <span className="text-sm">123 Hope Street, New York, NY 10001</span>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} HopeBridge. Made with <FaHeart className="inline text-red-500" /> for humanity.
          </p>
